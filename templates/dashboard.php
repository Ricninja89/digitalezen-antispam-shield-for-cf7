...
<div class="wrap" style="max-width: 800px;">
	...
	<?php
		...
		/**
		 * Conta i tentativi di spam per intervallo temporale.
		 *
		 * @param int $minutes Intervallo in minuti.
		 * @return array
		 */
	function dz_cf7_count_spam_by_type_and_range( $minutes ) {
					$csv_path = DZ_CF7_UPLOAD_DIR . 'cf7-spam-log.csv';
	...
	<table class="widefat striped" style="max-width: 100%; margin-top: 1em;">
		...
		<tbody>
		<?php
				$log_path = DZ_CF7_UPLOAD_DIR . 'cf7-spam-log.csv';
		if ( file_exists( $log_path ) ) {
				$lines = array_reverse( file( $log_path, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES ) );
			$max       = 30;

...
<div class="wrap" style="max-width: 800px;">
	...
	<p style="margin-top: 4px;">
            <?php echo esc_html__('Smart protection for Contact Form 7', 'digitalezen-cf7'); ?>
	</p>
	...
	<form method="POST">
	    <?php wp_nonce_field('dz_cf7_save_settings'); ?>
            ...
            <h2><?php esc_html_e('📬 Email report settings', 'digitalezen-cf7'); ?></h2>
	    <p>
	        <?php
                echo esc_html__(
	        ...
	        <tr>
	            <th scope="row">
	                <label for="dz_cf7_log_email">
                            <?php echo esc_html__('Destination email', 'digitalezen-cf7'); ?>
	                </label>
	            </th>
	            <td>
	    ...
	    <p>
	        <input type="submit" name="dz_cf7_settings_submit" class="button button-primary"
                       value="<?php esc_attr_e('Save settings', 'digitalezen-cf7'); ?>">
	    </p>
	</form>

	<hr>

        <h2><?php esc_html_e('🔧 Shortcodes to include in your CF7 forms', 'digitalezen-cf7'); ?></h2>
	<ul style="margin-left: 1em;">
	    <li>
	        ...
	        <a href="https://wordpress.org/plugins/contact-form-7-honeypot/" target="_blank" style="font-size: 0.9em; color: #0073aa; text-decoration: underline; margin-left: 6px;">
                <?php echo esc_html__('(Requires the Honeypot for Contact Form 7 plugin)', 'digitalezen-cf7'); ?>
	        </a>
	    </li>
	...
	<hr>
        ...
        <h2><?php esc_html_e('📁 Files generated by the plugin', 'digitalezen-cf7'); ?></h2>
	<table class="widefat striped" style="margin-bottom: 2em;">
	    <thead>
	        <tr>
	            <th><?php esc_html_e('File', 'digitalezen-cf7'); ?></th>
                    <th><?php esc_html_e('Description', 'digitalezen-cf7'); ?></th>
                    <th><?php esc_html_e('Actions', 'digitalezen-cf7'); ?></th>
	        </tr>
	    </thead>
	    <tbody>
	        <tr>
	            ...
	            <td>
	                <a
	                    ...
	                    class="button button-secondary" target="_blank">
                            👁️ <?php esc_html_e('View', 'digitalezen-cf7'); ?>
	                </a>
	        ...
	        <tr>
	            ...
	            <td>
                    <?php echo esc_html__('Spam attempt history by IP', 'digitalezen-cf7'); ?>
	            </td>
	            <td>
	                <a
	                    href="<?php
	        ...
	        <tr>
	            ...
	            <td>
                    <?php echo esc_html__('Spam attempt history by email', 'digitalezen-cf7'); ?>
	            </td>
	            <td>
	                <a
	                    href="<?php
	...
	<hr>
        ...
        <h2><?php esc_html_e('📊 Blocked spam report (real data)', 'digitalezen-cf7'); ?></h2>
	...
	?>
        ...
        <h3><?php esc_html_e('🧾 Latest blocked attempts', 'digitalezen-cf7'); ?></h3>
	<table class="widefat striped" style="max-width: 100%; margin-top: 1em;">
	    <thead>
	        <tr>
                    <th><?php esc_html_e('Date', 'digitalezen-cf7'); ?></th>
	            <th><?php esc_html_e('Email', 'digitalezen-cf7'); ?></th>
	            <th><?php esc_html_e('IP', 'digitalezen-cf7'); ?></th>
                    <th><?php esc_html_e('Reason', 'digitalezen-cf7'); ?></th>
